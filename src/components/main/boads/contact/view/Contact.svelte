...
<BoardLayout {title}>
    <h3 class="text-xl font-semibold text-[#6d0205] pt-4 pb-4">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div>
            <p>
                <strong>Domicilio Postal:</strong> Maestro Quiroga 51 (Planta Alta).
                San Fernando del Valle de Catamarca, Catamarca (CP 4700).
            </p>
            <h4 class="text-lg font-semibold mt-2">Teléfonos</h4>
            <ul>
                <li>• Despacho Decanato: Interno 1220</li>
                <li>• Posgrado: Interno 1223</li>
                <li>• Edificio Profesores: Interno 1224</li>
                <li>
                    • Unidad Alumnos: <a
                        class="text-blue-600"
                        href="tel:+543836014652">+54 383 6014652</a
                    >
                </li>
            </ul>
            <h4 class="text-lg font-semibold mt-2">Correo Electrónico</h4>
            <div class="grid grid-cols-2 gap-4">
                <div>
                    <h5 class="font-semibold">FCEYA Institucional</h5>
                    <a
                        class="text-blue-600"
                        href="mailto:infofceya@eco.unca.edu.ar"
                        >infofceya@eco.unca.edu.ar</a
                    >
                </div>
                <div>
                    <h5 class="font-semibold">TAES Distancia</h5>
                    <a
                        class="text-blue-600"
                        href="mailto:taes.distancia@eco.unca.edu.ar"
                        >taes.distancia@eco.unca.edu.ar</a
                    >
                </div>
            </div>
            <h4 class="text-lg font-semibold mt-2">Redes Sociales</h4>
            <div class="flex space-x-4">
                <a class="text-blue-600" href="https://www.facebook.com/FCEyA/"
                    >Facebook</a
                >
                <a
                    class="text-blue-600"
                    href="https://www.instagram.com/fceya_unca/">Instagram</a
                >
                <a
                    class="text-blue-600"
                    href="https://www.youtube.com/channel/UCNyrZBIm3TCmg53UVOkNSAg"
                    >YouTube</a
                >
            </div>
        </div>
        <div class="animate-slide-in-right">
            ...
            <div class="map-responsive">
                ...
                <iframe
                    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3507.646019726489!2d-65.7858501472445!3d-28.460085248751327!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x979408be7a82ec40!2sUNCa%3A+Facultad+de+Ciencias+Econ%C3%B3micas+y+de+Administraci%C3%B3n!5e0!3m2!1ses!2sar!4v1523626545652"
                    width="650"
                    height="450"
                    frameborder="0"
                    style="border:0"
    ...
    <p>
        <strong>Domicilio Postal:</strong> Av. José V. Figueroa 257. San Fernando
        del Valle de Catamarca, Catamarca (CP 4700).
    </p>
    <h4 class="text-lg font-semibold mt-2">Teléfonos</h4>
    <a class="text-blue-600" href="tel:+543834713890">+54 383 4713890</a>
    <h4 class="text-lg font-semibold mt-2">Correo Electrónico</h4>
    <p>
        Secretaría de Postgrado: <a
            class="text-blue-600"
            href="mailto:postgrado@economicasvirtual.edu.ar"
            >postgrado@economicasvirtual.edu.ar</a
        >
    </p>
    <p>
    ...
    <a
        class="text-blue-600"
        href="https://www.facebook.com/postgradoFCEyA"
        target="_blank">Facebook</a
    >

    <!-- Sección Educación a Distancia -->
    <h3 class="text-xl font-semibold text-[#6d0205] pt-4">
        ÁREA EDUCACIÓN A DISTANCIA FCEyA
    </h3>
    <h4 class="text-lg font-semibold mt-2">Correos Electrónicos</h4>
    <ul>
        <li>
            <a
                class="text-blue-600"
                href="mailto:alumnos.distancia@eco.unca.edu.ar"
                >alumnos.distancia@eco.unca.edu.ar</a
            >
        </li>
        <li>
            <a
                class="text-blue-600"
                href="mailto:info.distancia@eco.unca.edu.ar"
                >info.distancia@eco.unca.edu.ar</a
            >
        </li>
    </ul>
    <h4 class="text-lg font-semibold mt-2">Redes Sociales</h4>
    <div class="flex space-x-4">
        <a
            href="https://api.whatsapp.com/send/?phone=5493834528158&text=Hola%2C+quisiera+conocer+m%C3%A1s+acerca+de+las+Ofertas+a+Distancia+de+la+FCEYA&app_absent=0"
            target="_blank"
            aria-label="WhatsApp"
        >
            <svg
        ...
        <a
            href="https://www.facebook.com/FCEYA.distancia"
            target="_blank"
        ...
        <a
            href="https://www.instagram.com/distancia.fceya/"
            target="_blank"
    ...
    <h3 class="text-xl font-semibold text-[#6d0205] pt-4">SOPORTE TÉCNICO</h3>
    <p>
        Plataforma Virtual: <a
            class="text-blue-600"
            href="mailto:admin@economicasvirtual.edu.ar"
            >admin@economicasvirtual.edu.ar</a
        ><br />
        Gestión de Correos Institucionales:
        <a class="text-blue-600" href="mailto:jmolina@eco.unca.edu.ar"
            >jmolina@eco.unca.edu.ar</a
        >
    </p>
</BoardLayout>
