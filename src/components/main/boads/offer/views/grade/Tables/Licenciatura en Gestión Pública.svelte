<table>
    <tbody
        ><tr>
            ...
            <td><strong>CORRELATIVAS</strong></td>
            <td><strong>CUATRIMESTRE</strong></td>
        </tr>

        <tr>
            <th colspan="4">CICLO BÁSICO</th>
        </tr>
        ...
        <tr>
            <th colspan="4">CICLO DE FORMACIÓN PROFESIONAL</th>
        </tr>
        ...
        <tr>
            <th colspan="4"
                >ACREDITACIÓN DE CONOCIMIENTOS AL FINALIZAR EL 2DO. CUATRIMESTRE</th
            >
        </tr>
        ...
        <tr>
            <td>538</td>
            <td>Práctica Profesional Académica</td>
            <td>529 - 546</td>
            <td>5C</td>
        </tr>
    </tbody>
