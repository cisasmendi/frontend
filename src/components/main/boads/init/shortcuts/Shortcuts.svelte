...
<div class="marquee-wrapper">
    {#each Array(numberOfCopies) as _, i}
...
<style>
    ...
    /* Contenedor del marquee con animación */
    .marquee-container {
        display: flex;
        flex-shrink: 0;
        gap: 1rem;
    ...
    /* Todas las copias se mueven en la misma dirección */
    /* Se eliminó la alternancia de dirección */
