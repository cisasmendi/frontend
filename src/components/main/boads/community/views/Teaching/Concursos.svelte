...
<BoardLayout title="Concursos">
    ...
    <Accordion title={"Concursos 2025"}>
        <div slot="content">
            <ul class="pt-2 pl-10">
                <li class="pt-2">
                    <a
    ...
    <Accordion title={"Concursos 2024"}>
        <div slot="content">
            <ul class="pt-2 pl-10">
                <li class="pt-2">
                    <a
    ...
    <Accordion title={"Designación miembros del jurado"}>
        <div slot="content">
            <ul class="pt-2 pl-10">
                <li class="pt-2">
                    <a
    ...
    <Accordion title={"Documentación referencial"}>
        <div slot="content">
            <ul class="pt-2 pl-10">
                <li class="pt-2">
                    <a
